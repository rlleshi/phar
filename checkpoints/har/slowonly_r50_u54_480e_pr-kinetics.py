...
data_root_val = '/mmaction2/data/'
data_root_test = '/mmaction2/data/'
ann_file_train = '/mmaction2/data/train.pkl'
ann_file_val = '/mmaction2/data/val.pkl'
ann_file_test = '/mmaction2/data/val.pkl'
num_classes = 6
...
data = dict(videos_per_gpu=16,
            ...
            train=dict(type='PoseDataset',
                       ann_file='/mmaction2/data//train.pkl',
                       data_prefix='',
                       pipeline=[
                           dict(type='UniformSampleFrames', clip_len=54),
                           dict(type='PoseDecode'),
            ...
            val=dict(type='PoseDataset',
                     ann_file='/mmaction2/data//val.pkl',
                     data_prefix='',
                     pipeline=[
...
load_from = ('https://download.openmmlab.com/mmaction/skeleton/posec3d/'
             'slowonly_kinetics400_pretrained_r50_u48_120e_ucf101_split1_'
             'keypoint/slowonly_kinetics400_pretrained_r50_u48_120e_ucf101'
             '_split1_keypoint-cae8aa4a.pth')
resume_from = None
find_unused_parameters = False
work_dir = 'work_dir/posec3d/'
gpu_ids = range(0, 1)
omnisource = False
module_hooks = []
